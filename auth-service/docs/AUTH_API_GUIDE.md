...
**Business codes** (patients, doctors, invoices, etc.): see [`docs/CODES.md`](../../docs/CODES.md). Format `{tenantCode}-{TYPE}-{#####}`; JWT must include `tenantCode`. Patients no longer have `patientDisplayId`.
